...
class CustomTabBar: UIView {
    ...
    func createTabItem(item: TabItem) -> UIView {
        ...
        itemTitleLabel.font = .systemFont(ofSize: 12)
        itemTitleLabel.textColor = .borderColor()
        ...
        itemImageView.tintColor = .iconColor()
    ...
    func activateTab(tab: Int) {
        ...
        borderLayer.backgroundColor = UIColor.mainColor().cgColor
        borderLayer.name = "Active Border"
        borderLayer.frame = CGRect(x: tabToActivate.frame.width/2 - borderWidth/4, y: 0, width: borderWidth/2, height: 2)
